...
const HomeFAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      body: (
        <p className={cardBodyStyles}>
          The conference will be held on <strong className={strongStyles}>March 20th, 2026</strong> at the University of Michigan, Leinweber Computer Science and Information Building from
